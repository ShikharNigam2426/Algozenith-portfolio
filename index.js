...
// Normal scroll for navigation links (instant jump)
...
document.querySelectorAll('section, .skill-card, .experience-card, .project-card-large, .award-card, .education-card').forEach(el => {
...
const progressObserver = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            const counter = bar.parentElement.previousElementSibling.querySelector('.fw-bold');
            if (counter) {
...
// Parallax effect removed for normal scroll behavior
